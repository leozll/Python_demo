...
if __name__ == '__main__':
	try:
		...
		cur.execute(
			...
			select
			ExportTime,mobile,snsId,timestamp,authorId,comments,content,authorName,isCurrentUser,likes,mediaList,rawXML,MomentTime
			from wechat.dbo.MobileMoment b where mobile='15214339496' and exporttime>'2016-10-20 08:24:27.107'  and not exists
			(select snsid from wechat.dbo.MobileMomentspider a where a.mobile='15214339496' and a.exporttime>'2016-10-20 08:24:27.107'
			AND a.snsid=b.snsid)
			""")	
