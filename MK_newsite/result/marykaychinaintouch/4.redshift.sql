DROP TABLE IF EXISTS ods.stgomnitureintouchwebhit;
DROP TABLE IF EXISTS ods.fctomnitureintouchwebhit;
DROP TABLE IF EXISTS ods.stgomnitureintouchweblookupvalue;
DROP TABLE IF EXISTS dw.dimomnitureintouchweblookupvalue;
DROP TABLE IF EXISTS ods.stgomnitureintouchwebvisit;
DROP TABLE IF EXISTS dw.fctomnitureintouchwebvisit;
DROP TABLE IF EXISTS dw.fctomnitureintouchwebpageview;
DROP TABLE IF EXISTS dw.fctomnitureintouchwebvisitor;
DROP TABLE IF EXISTS ods.stgomnitureintouchwebevent;
DROP TABLE IF EXISTS dw.fctomnitureintouchwebevent;
DROP TABLE IF EXISTS ods.fctomnitureintouchwebhitarchive;
DROP TABLE IF EXISTS dw.fctomnitureintouchwebpageviewarchive;
DROP TABLE IF EXISTS dw.fctomnitureintouchwebvisitarchive;
DROP TABLE IF EXISTS dw.fctomnitureintouchwebeventarchive;


CREATE TABLE ods.stgomnitureintouchwebhit
(
	...
	prop_ThirdLevelSiteSection VARCHAR(255) ENCODE zstd,
...
CREATE TABLE ods.fctomnitureintouchwebhit
(
	hitkey VARCHAR(255) ENCODE zstd,
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
...
CREATE TABLE ods.stgomnitureintouchweblookupvalue
(
...
CREATE TABLE dw.dimomnitureintouchweblookupvalue
(
	reportsuiteid VARCHAR(50) ENCODE zstd,
	type VARCHAR(30) ENCODE zstd,
	keyid BIGINT ENCODE zstd,
...
CREATE TABLE ods.stgomnitureintouchwebvisit
(
...
CREATE TABLE dw.fctomnitureintouchwebvisit
(
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
	monthkey INTEGER ENCODE zstd,
...
CREATE TABLE dw.fctomnitureintouchwebpageview
(
	hitkey VARCHAR(80) ENCODE zstd,
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
	...
	ThirdLevelSiteSection VARCHAR(255) ENCODE zstd,
...
CREATE TABLE dw.fctomnitureintouchwebvisitor
(
...
CREATE TABLE ods.stgomnitureintouchwebevent
(
	hitkey VARCHAR(80) ENCODE zstd,
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
...
CREATE TABLE dw.fctomnitureintouchwebevent
(
	hitkey VARCHAR(80) ENCODE zstd,
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
...
CREATE TABLE ods.fctomnitureintouchwebhitarchive
(
	hitkey VARCHAR(255) ENCODE zstd,
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
...
CREATE TABLE dw.fctomnitureintouchwebpageviewarchive
(
	hitkey VARCHAR(80) ENCODE zstd,
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
...
CREATE TABLE dw.fctomnitureintouchwebvisitarchive
(
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
	monthkey INTEGER ENCODE zstd,
...
CREATE TABLE dw.fctomnitureintouchwebeventarchive
(
	hitkey VARCHAR(80) ENCODE zstd,
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
