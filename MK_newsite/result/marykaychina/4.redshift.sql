DROP TABLE IF EXISTS ods.stgomniturechinacorphit;
DROP TABLE IF EXISTS ods.fctomniturechinacorphit;
DROP TABLE IF EXISTS ods.stgomniturechinacorplookupvalue;
DROP TABLE IF EXISTS dw.dimomniturechinacorplookupvalue;
DROP TABLE IF EXISTS ods.stgomniturechinacorpvisit;
DROP TABLE IF EXISTS dw.fctomniturechinacorpvisit;
DROP TABLE IF EXISTS dw.fctomniturechinacorppageview;
DROP TABLE IF EXISTS dw.fctomniturechinacorpvisitor;
DROP TABLE IF EXISTS ods.stgomniturechinacorpevent;
DROP TABLE IF EXISTS dw.fctomniturechinacorpevent;
DROP TABLE IF EXISTS ods.fctomniturechinacorphitarchive;
DROP TABLE IF EXISTS dw.fctomniturechinacorppageviewarchive;
DROP TABLE IF EXISTS dw.fctomniturechinacorpvisitarchive;
DROP TABLE IF EXISTS dw.fctomniturechinacorpeventarchive;


CREATE TABLE ods.stgomniturechinacorphit
(
	...
	prop_site VARCHAR(255) ENCODE zstd,
...
CREATE TABLE ods.fctomniturechinacorphit
(
	hitkey VARCHAR(255) ENCODE zstd,
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
...
CREATE TABLE ods.stgomniturechinacorplookupvalue
(
...
CREATE TABLE dw.dimomniturechinacorplookupvalue
(
	reportsuiteid VARCHAR(50) ENCODE zstd,
	type VARCHAR(30) ENCODE zstd,
	keyid BIGINT ENCODE zstd,
...
CREATE TABLE ods.stgomniturechinacorpvisit
(
...
CREATE TABLE dw.fctomniturechinacorpvisit
(
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
	monthkey INTEGER ENCODE zstd,
...
CREATE TABLE dw.fctomniturechinacorppageview
(
	hitkey VARCHAR(80) ENCODE zstd,
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
...
CREATE TABLE dw.fctomniturechinacorpvisitor
(
...
CREATE TABLE ods.stgomniturechinacorpevent
(
	hitkey VARCHAR(80) ENCODE zstd,
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
...
CREATE TABLE dw.fctomniturechinacorpevent
(
	hitkey VARCHAR(80) ENCODE zstd,
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
...
CREATE TABLE ods.fctomniturechinacorphitarchive
(
	hitkey VARCHAR(255) ENCODE zstd,
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
...
CREATE TABLE dw.fctomniturechinacorppageviewarchive
(
	hitkey VARCHAR(80) ENCODE zstd,
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
...
CREATE TABLE dw.fctomniturechinacorpvisitarchive
(
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
	monthkey INTEGER ENCODE zstd,
...
CREATE TABLE dw.fctomniturechinacorpeventarchive
(
	hitkey VARCHAR(80) ENCODE zstd,
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
