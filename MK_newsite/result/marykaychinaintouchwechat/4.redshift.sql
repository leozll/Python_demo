DROP TABLE IF EXISTS ods.stgomnitureintouchwechathit;
DROP TABLE IF EXISTS ods.fctomnitureintouchwechathit;
DROP TABLE IF EXISTS ods.stgomnitureintouchwechatlookupvalue;
DROP TABLE IF EXISTS dw.dimomnitureintouchwechatlookupvalue;
DROP TABLE IF EXISTS ods.stgomnitureintouchwechatvisit;
DROP TABLE IF EXISTS dw.fctomnitureintouchwechatvisit;
DROP TABLE IF EXISTS dw.fctomnitureintouchwechatpageview;
DROP TABLE IF EXISTS dw.fctomnitureintouchwechatvisitor;
DROP TABLE IF EXISTS ods.stgomnitureintouchwechatevent;
DROP TABLE IF EXISTS dw.fctomnitureintouchwechatevent;
DROP TABLE IF EXISTS ods.fctomnitureintouchwechathitarchive;
DROP TABLE IF EXISTS dw.fctomnitureintouchwechatpageviewarchive;
DROP TABLE IF EXISTS dw.fctomnitureintouchwechatvisitarchive;
DROP TABLE IF EXISTS dw.fctomnitureintouchwechateventarchive;


CREATE TABLE ods.stgomnitureintouchwechathit
(
	...
	prop_FirstLevelSiteSections VARCHAR(255) ENCODE zstd,
	prop_PageType VARCHAR(255) ENCODE zstd,
	prop_SecondLevelSiteSections VARCHAR(255) ENCODE zstd,
	prop_ThirdLevelSiteSections VARCHAR(255) ENCODE zstd,
...
CREATE TABLE ods.fctomnitureintouchwechathit
(
	hitkey VARCHAR(255) ENCODE zstd,
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
...
CREATE TABLE ods.stgomnitureintouchwechatlookupvalue
(
...
CREATE TABLE dw.dimomnitureintouchwechatlookupvalue
(
	reportsuiteid VARCHAR(50) ENCODE zstd,
	type VARCHAR(30) ENCODE zstd,
	keyid BIGINT ENCODE zstd,
...
CREATE TABLE ods.stgomnitureintouchwechatvisit
(
...
CREATE TABLE dw.fctomnitureintouchwechatvisit
(
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
	monthkey INTEGER ENCODE zstd,
...
CREATE TABLE dw.fctomnitureintouchwechatpageview
(
	hitkey VARCHAR(80) ENCODE zstd,
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
	...
	FirstLevelSiteSections VARCHAR(255) ENCODE zstd,
	PageType VARCHAR(255) ENCODE zstd,
	SecondLevelSiteSections VARCHAR(255) ENCODE zstd,
	ThirdLevelSiteSections VARCHAR(255) ENCODE zstd,
...
CREATE TABLE dw.fctomnitureintouchwechatvisitor
(
...
CREATE TABLE ods.stgomnitureintouchwechatevent
(
	hitkey VARCHAR(80) ENCODE zstd,
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
...
CREATE TABLE dw.fctomnitureintouchwechatevent
(
	hitkey VARCHAR(80) ENCODE zstd,
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
...
CREATE TABLE ods.fctomnitureintouchwechathitarchive
(
	hitkey VARCHAR(255) ENCODE zstd,
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
...
CREATE TABLE dw.fctomnitureintouchwechatpageviewarchive
(
	hitkey VARCHAR(80) ENCODE zstd,
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
...
CREATE TABLE dw.fctomnitureintouchwechatvisitarchive
(
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
	monthkey INTEGER ENCODE zstd,
...
CREATE TABLE dw.fctomnitureintouchwechateventarchive
(
	hitkey VARCHAR(80) ENCODE zstd,
	visitkey VARCHAR(70) ENCODE zstd DISTKEY,
	visitorkey VARCHAR(60) ENCODE zstd,
